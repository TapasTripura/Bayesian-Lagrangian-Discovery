...
from hnn import HNN
from data_3dof import get_dataset
from utils import L2_loss, rk4

def get_args():
    parser = argparse.ArgumentParser(description=None)
    parser.add_argument('--input_dim', default=2*3, type=int, help='dimensionality of input tensor')
    ...
    parser.add_argument('--name', default='mdof', type=str, help='only one option right now')
